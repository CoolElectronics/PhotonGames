...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        public virtual void MoveCharacter(Vector3 _direction)
        {
            ...
            if (!(timeSinceGrounded > 0) || isJumping) return;
        ...
        {
            if (!jumpAndRotate && !(timeSinceGrounded > 0)) return;
            direction.y = 0f;
        ...
        public virtual void AirControl()
        {
            ...
            if (jumpWithRigidbodyForce && !(timeSinceGrounded > 0))
            {
        ...
        protected virtual void CheckGround()
        {
            ...
            {
                isGrounded = true;
                timeSinceGrounded = groundRememberTime;
        ...
        protected virtual void ControlMaterialPhysics()
        {
            ...
            _capsuleCollider.material = (timeSinceGrounded > 0 && GroundAngle() <= slopeLimit + 1) ? frictionPhysics : slippyPhysics;

            if (timeSinceGrounded > 0 && input == Vector3.zero)
                _capsuleCollider.material = maxFrictionPhysics;
            else if (timeSinceGrounded > 0 && input != Vector3.zero)
